...
#include "../../Qt_BMS_485IAP_V2/ymodem.h"
...
QT_MOC_LITERAL(1, 7, 19), // "transmitDebugMessge"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 6) // "Messge"

    },
    "Ymodem\0transmitDebugMessge\0\0Messge"
};
...
void Ymodem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->transmitDebugMessge((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Ymodem::transmitDebugMessge)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Ymodem::transmitDebugMessge(const QString & _t1)
{
